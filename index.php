...
<main role="main" class="d-flex justify-content-center inner cover pb-5">
  ...
  <h1 class="d-flex justify-content-center inner cover mt-5">See all auctions<a href="/ikea/auctions.php" class="ml-5 btn btn-lg btn-warning">Auctions</a></h1>
